...
The part that interest us is the fine-tuning one, this model can be used in several ways for downstream applications like: sequence classification, token classification, sequence generation
